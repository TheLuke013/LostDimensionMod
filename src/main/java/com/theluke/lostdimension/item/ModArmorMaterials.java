...
public enum ModArmorMaterials implements ArmorMaterial {
    LOST("lost", 25, new int[]{3, 8, 6, 3}, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.LOST_INGOT));
    ...
    public String getName() {
        return LostDimension.MOD_ID + ":" + this.name;
    }
